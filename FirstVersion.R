...
#teams <- read_excel("PracticeData.xlsx", sheet = "18-19 Team")
#salaries <- read_excel("PracticeData.xlsx", sheet = "18-19 Salary")
comb <- read_excel("PracticeData.xlsx", sheet = "Combined")
